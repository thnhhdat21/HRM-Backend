...
@RestController
@RequestMapping("/manage-decision")
@RequiredArgsConstructor
public class ManageDecisionController {
    private final DecisionService decisionService;

    @PostMapping("/get-list-decision")
    @PreAuthorize("hasAnyAuthority('ADMIN','ROLE_WATCH_DECISION_COMPANY', 'ROLE_WATCH_DECISION_DEPARTMENT')")
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN','ROLE_CREATE_DECISION')")
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN','ROLE_MANAGE_DECISION', 'ROLE_CREATE_DECISION')")
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN','ROLE_MANAGE_DECISION')")
